						...
						<ul class="nav navbar-nav">
							...
							<li><a class="active" href="blog.do"> Blog <i
								...
								<ul class="dropdown">
									...
									<li><a class="active" href="single-post.do"> Blog
											Single Post </a></li>
								</ul></li>
						</ul>
				...
				<ul class="wpb-mobile-menu">
					...
					<li><a class="active" href="blog.do">Blog</a>
						<ul class="dropdown">
							...
							<li><a href="blog-full-post.do">Blog - Full Width</a></li>
							<li><a class="active" href="single-post.do">Blog Single
									Post</a></li>
						</ul></li>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="breadcrumb-wrapper">
						<h2 class="product-title">Single Post</h2>
						<ol class="breadcrumb">
					...
					<div class="blog-post">
						...
						<div class="post-content">
							...
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
								...
								voluptas quae voluptatum, perferendis eum, doloremque.</p>
							<blockquote>
						...
						<div id="respond">
							...
							<form action="#">
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<input id="author" class="form-control" name="author"
												type="text" value="" size="30" placeholder="Enter your name">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<input id="email" class="form-control" name="author"
									...
									<div class="col-md-12">
										<div class="form-group">
											<input id="subject" class="form-control" name="author"
												type="text" value="" size="30"
