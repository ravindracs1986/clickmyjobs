						...
						<ul class="nav navbar-nav">
							...
							<li><a class="active" href="#"> Candidates <i
								...
								<ul class="dropdown">
									...
									<li><a class="active" href="manageresumes.do"> Manage
											Resumes </a></li>
			...
			<div class="row">
				<div class="col-md-4 col-sm-4 col-xs-12">
					<div class="right-sideabr">
						<div class="inner-box">
							...
							<h4>Manage Job</h4>
							<ul class="lest item">
								<li><a href="jobalerts.do">Manage Jobs</a></li>
								<li><a href="manageapplications.do">Manage Applications</a></li>
								<li><a class="active" href="manageresumes.do">Manage
										Resume</a></li>
							</ul>
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
					<div class="job-alerts-item candidates">
						...
						<div class="manager-resumes-item">
							...
							<div class="update-date">
								...
								<div class="action-btn">
									<a class="btn btn-xs btn-gray" href="#">Hide</a> <a
										class="btn btn-xs btn-gray" href="#">Edit</a> <a
										class="btn btn-xs btn-danger" href="#">Delete</a>
								</div>
							</div>
						</div>
						<div class="manager-resumes-item">
						...
						<a class="btn btn-common btn-sm" href="addResume.do">Add new
							resume</a>
					</div>
				</div>
			</div>
