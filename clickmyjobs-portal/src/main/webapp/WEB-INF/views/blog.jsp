...
<title>MyJobs-Portal-Blog</title>
		...
		<div class="logo-menu">
			<nav class="navbar navbar-default main-navigation" role="navigation"
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="navbar">
						...
						<ul class="nav navbar-nav">
							...
							<li><a class="active" href="blog.do"> Blog <i
									class="fa fa-angle-down"></i>
							</a>
								<ul class="dropdown">
									<!-- <li><a class="active" href="blog.do"> Blog - Right
											Sidebar </a></li>
				...
				<ul class="wpb-mobile-menu">
					...
					<li><a class="active" href="blog.do">Blog</a>
						<ul class="dropdown">
							<!-- <li><a class="active" href="blog.do">Blog - Right
									Sidebar</a></li>
					...
					<div class="col-md-9">
						...
						<div class="blog-post">
							...
							<div class="post-content">
								...
								<p>Fusce fermentum ipsum mauris, rutrum ultrices ligula
									sodales et. Maecenas pellentesque aliquet arcu, vel elementum
									magna facilisis vitae. Nam in cursus lorem. Donec ac tellus
									nisl. Sed volutpat quis orci nec placerat. Fusec ex magna,
									congue sed vulpu-tate rhoncus, laoreet nec sapien.</p>
						...
						<div class="blog-post">
							...
							<div class="post-content">
								<h3 class="post-title">
									<a href="#">Employer branding: Get behind the wheel!</a>
								</h3>
								<div class="meta">
									<span class="meta-part"><a href="#"><i
											class="ti-user"></i> By Admin</a></span> <span class="meta-part"><i
						...
						<div class="blog-post">
							...
							<div class="post-content">
								<h3 class="post-title">
									<a href="#">How to convince recruiters and get your dream
										job</a>
								</h3>
								<div class="meta">
									<span class="meta-part"><a href="#"><i
							...
							<div class="widget">
								...
								<div class="textwidget">
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
										...
										quis. Etiam euismod ornare elementum. Sed ex est, consectetur
