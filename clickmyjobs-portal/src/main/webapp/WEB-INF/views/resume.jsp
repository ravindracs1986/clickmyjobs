						...
						<ul class="nav navbar-nav">
							...
							<li><a class="active" href="about.do"> About us <i
								...
								<ul class="dropdown">
									...
									<li><a class="active" href="resume.do"> Resume Page </a></li>
				...
				<div class="col-md-4 col-sm-4 col-xs-12">
					<div class="right-sideabr">
						<div class="inner-box">
							...
							<ul class="lest item">
								<li><a class="active" href="resume.do">My Resume</a></li>
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
					<div class="inner-box my-resume">
						...
						<div class="about-me item">
							...
							<p>Nullam semper erat arcu, ac tincidunt sem venenatis vel.
								Curabitur a dolor ac ligula fermentum eusmod ac ullamcorper
								nulla. Integer blandit uitricies aliquam. Pellentesque quis dui
								varius, dapibus vilit id, ipsum. Morbi ac eros feugiat, lacinia
								elit ut, elementum turpis. Curabitur justo sapien, tempus sit
								amet ruturm eu, commodo eu lacus. Morbi in ligula nibh. Maecenas
								ut mi at odio hendririt eleif end tempor vitae augue. Fusce eget
								arcu et nibh dapibus maximus consectetur in est. Sed iaculis
								Luctus nibh sed veneatis.</p>
						</div>
						<div class="work-experence item">
							...
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
								Libero vero, dolores, officia quibusdam architecto sapiente eos
								voluptas odit ab veniam porro quae possimus itaque, quas!
								Tempora sequi nobis, atque incidunt!</p>
							<p>
								<a href="#">4 Projects</a>
							</p>
							<br>
