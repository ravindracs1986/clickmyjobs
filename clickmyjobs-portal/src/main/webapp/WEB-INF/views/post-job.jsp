					...
					<div class="collapse navbar-collapse" id="navbar">
						...
						<ul class="nav navbar-nav">
							...
							<li><a class="active" href="#"> Employers <i
								...
								<ul class="dropdown">
									<li><a class="active" href="addjobs.do"> Add Job </a></li>
				...
				<div class="col-sm-12 col-md-9 col-md-offset-2">
					<fieldset>
						...
						<div class="field account-sign-in">
							<p>
								<a class="btn btn-common btn-sm" href="my-account.do"><i
									class="ti-key"></i> Sign in</a>
							</p>
							<div class="alert alert-info alert-dismissable">
								...
								entering your email address. A password will be automatically
								emailed to you.
							</div>
						</div>
					</fieldset>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="site-info text-center">
							<p>
								All copyrights reserved @ 2017 - Design & Development by <a
